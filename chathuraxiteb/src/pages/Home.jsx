...
export default function Featured() {
    ...
    return (
        <div className='max-w-auto h-[600px] w-full py-4 px-4 relative'>
            ...
            <div className='grid grid-cols-1 gap-2 md:grid-cols-4 absolute bottom-10  justify-center items-center px-4 max-w-[1300px] md:w-full'>
    <input type="date" placeholder="2010" className="border border-gray-300 rounded-md p-2 mr-2 w-full md:w-auto" />
    <input type="text" placeholder="1 person 1 room" className="border border-gray-300 rounded-md p-2 mr-2 w-full md:w-auto" />
    <input type="text" placeholder="special code" className="border border-gray-300 rounded-md p-2 mr-2 w-full md:w-auto" />
    <button className="bg-yellow-500 text-white px-4 py-2 rounded-md w-36">Search</button>
</div>
